...
var force = d3.layout.force()
    .size([width, height])
    .nodes(initNodes())//[{x:100, y:100},{x:100,y:100},{x:100,y:100},{x:100,y:100},{x:100,y:100}]) // initialize with a single node
...
function initNodes(){
  ...
  nodesList = nodes;//[{'x':100, 'y':100},{'x':100, 'y':100},{'x':100, 'y':100}]
  startD3JS();
  return nodesList;
}
